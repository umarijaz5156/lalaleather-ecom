<div class="mx-8">
                        ...
                        <tbody>
                            ...
                            @forelse ($category->childCategories as $child)
                                ...
                                <tr class="{{ $showHideLevel3 == $child->id ? '' : 'hidden' }}">
                                    <x-admin.table.cell class="bg-gray-400" colspan="5">
                                        <x-admin.table>
                        <tbody>
                            {{-- Sub Child Foreach --}}
                                ...
                                <tr>
                                    ...
                                    <x-admin.table.cell>
                                        ...
                                        <div class="" uk-lightbox="animation: scale">
                                            <div>
                                                <a class="uk-inline"
                                                    href="{{ asset('storage/' . $subChild->banner_path) }}"
                                                    data-caption="Caption 1">
                                                    <img src="{{ asset('storage/' . $subChild->banner_path) }}"
                                                        class="w-20 h-20 object-cover rounded-[6px]" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <x-admin.table.cell>
                                        ...
                                        <div class="" uk-lightbox="animation: scale">
                                            <div>
                                                <a class="uk-inline"
                                                    href="{{ asset('storage/' . $subChild->icon_path) }}"
                                                    data-caption="Caption 1">
                                                    <img src="{{ asset('storage/' . $subChild->icon_path) }}"
                                                        class="w-20 h-20 object-cover rounded-[6px]" alt="">
                                                </a>
                                            </div>
                                        </div>
    ...
    <!-- Add Category modal -->
    @if ($addNewCategory)
        <x-modals.modal wire:model="addNewCategory" maxWidth="5xl">
            @slot('headerTitle')
                Add New Category
            @endslot
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Category
                                Title</label>
                            <input type="text" wire:model.defer="title" maxlength="255"
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Slug
                                Store</label>
                            <input type="text" wire:model.defer="slugStore"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Slug
                                Manufacturer</label>
                            <input type="text" wire:model.defer="slugManufacturer"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        ...
                        <div>
                            <label
                                ...
                                Description</label>
                            <textarea type="text" wire:model.defer="shortDescription" maxlength="300" placeholder="Short Description"
                        ...
                        <div>
                            ...
                            <textarea type="text" wire:model.defer="description" maxlength="1000" placeholder="Description"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"></textarea>
                            @error('description')
                                <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            <label for="promotion"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Promotion</label>
                            <select wire:model.defer="promotion"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                <option value="">Choose...</option>
                                {{-- promotions --}}
                        ...
                        <div>
                            ...
                            <select wire:model.defer="enabled"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Cover
                                    Photo</label>
                                <p class="text-xs">dimensions 360-370x410-420 px required</p>
                                <input type="file" wire:model.defer="cover_photo" name="coverPhoto"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                {{-- <x-inputs.image-upload wire:model.defer="cover_photo" fileName="coverPhoto" /> --}}
                                @error('cover_photo')
                                    <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="file" wire:model.defer="category_icon" name="categoryIcon"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                {{-- <x-inputs.image-upload wire:model.defer="category_icon" fileName="categoryIcon" /> --}}
                                @error('category_icon')
                                    <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                                @enderror
                            </div>
    ...
    @if ($editCategoryModal)
        <x-modals.modal wire:model="editCategoryModal" maxWidth="5xl">
            @slot('headerTitle')
                Edit Category
            @endslot
                    ...
                    <div class="py-2">
                        ...
                        {{-- <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Category
                                    Tagline</label>
                                <input type="text" wire:model.defer="tagline" name="tagline" value="{{ old('tagline') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
