        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                    ...
                    <a href="{{ route('admin.create-size') }}"
                ...
                <div class="items-center justify-end mt-2 mr-2 mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search"
                            ...
                            placeholder="Search Size charts..." wire:model="searchTerm" required>
                    </div>
                </div>
                            ...
                            @if (count($sizes) > 0)
                                @foreach ($sizes as $key => $size)
                                    <tr>
                                        ...
                                        <td
                                            class="text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <h6 class="mb-0 leading-normal text-sm">{{ $size->name }}</h6>
                                        </td>
                                        <td
                                            class="text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            @if ($size->images->isNotEmpty())
                                                <div class="flex justify-center">
                                                    <img src="{{ asset('storage/' . $size->images->first()->file_path) }}"
                                                        class="h-12 w-12 object-cover rounded-full border border-gray-300"
                                                        alt="Size Charts" />
                                                </div>
                                            @endif
                                        </td>
                                        <td
                                            ...
                                            <div class="flex justify-center text-center">
                                                <button type="button" wire:click="destroy({{ $size->id }})" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Delete</button>
                                                <a href="{{ route('admin.size.edit', $size->id) }}" type="button" class="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Edit</a>
                                            </div>
